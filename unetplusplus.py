...
class UNet(nn.Module):
    def __init__(self, num_classes, input_channels=3, **kwargs):
        ...
        self.conv2_2 = DoubleConv(nb_filter[2]+nb_filter[3], nb_filter[2], nb_filter[2])
        self.conv1_3 = DoubleConv(nb_filter[1]+nb_filter[2], nb_filter[1], nb_filter[1])
        self.conv0_4 = DoubleConv(nb_filter[0]+nb_filter[1], nb_filter[0], nb_filter[0])
